            ...
            <div class="col-md-6">
                ...
                <form class="form-horizontal" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="date" class="form-control" name="sightingDate" placeholder="Date"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select multiple class="form-control" name="superSomeonesSighted" placeholder="Super Someones">
