            ...
            <div>
                <sf:form class="form-horizontal" role="form" modelAttribute="superSomeone"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <sf:input type="text" class="form-control" id="add-super-someone-name"
                                      path="superSomeoneName" placeholder="Name"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <sf:input type="text" class="form-control" id="add-super-someone-type"
                                      path="superSomeoneType" placeholder="Type"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <sf:input type="text" class="form-control" id="add-super-someone-alias"
                                      path="superSomeoneAlias" placeholder="Alias"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <sf:input type="text" class="form-control" id="add-super-someone-description"
                                      path="superSomeoneDescription" placeholder="Description"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select multiple class="form-control" name="superPowers" placeholder="Powers">
