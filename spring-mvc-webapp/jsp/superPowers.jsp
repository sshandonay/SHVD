            ...
            <div class="col-md-6">
                ...
                <form class="form-horizontal" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="superPowerName" placeholder="Name"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add-super-power-description" class="col-md-4 control-label">Description:</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="superPowerDescription" placeholder="Description"/>
                        </div>
                    </div>
