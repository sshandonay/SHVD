            ...
            <div class="col-md-6">
                ...
                <form class="form-horizontal" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="organizationType" placeholder="Org Type: (Hero, Villain, Unknown)"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="organizationContact" placeholder="Contact"/>
                        </div>
                    </div>
