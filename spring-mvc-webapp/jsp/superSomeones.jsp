            ...
            <div class="col-md-6">
                ...
                <form class="form-horizontal" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="superSomeoneName" placeholder="Name"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add-super-someone-type" class="col-md-4 control-label">Super Someone Type:</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="superSomeoneType" placeholder="Type (Hero or Villain)"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add-super-someone-alias" class="col-md-4 control-label">Super Someone Alias:</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="superSomeoneAlias" placeholder="Alias"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="add-super-someone-description" class="col-md-4 control-label">Description:</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="superSomeoneDescription" placeholder="Description"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select multiple class="form-control" name="superSomeoneSuperPower" placeholder="Super Powers">
